            ...
            <div className="body-content">
                <form autoComplete="off" noValidate onSubmit={handleSubmit} className="form">
                    ...
                    <div className="image-tag" >
                        ...
                        <input type="file" accept="image/*" className={"form-control-file" + applyErrorClass('profileSrc')}
                    ...
                    <div className="input-box">
                        ...
                        <div className="column">
                            ...
                            <div className="select-box">
                                <select
                                    className={applyErrorClass('gender')}
                                    name="gender"
                                    value={values.gender}
                                    onChange={handleInputChange} >
                    ...
                    <div className="column">
                        ...
                        <div className="input-box">
                            ...
                            <div className="select-box">
                                <select
                                    className={applyErrorClass('department')}
                                    name="department"
                        ...
                        <div className="input-box">
                            ...
                            <input type="text" className={"form-control" + applyErrorClass('employeeId')} placeholder="Employee Id" name="employeeId"
                    ...
                    <div className="column">
                        <div className="input-box">
                            ...
                            <input type="password" className={"form-control" + applyErrorClass('password')} placeholder="Password" name="password"
